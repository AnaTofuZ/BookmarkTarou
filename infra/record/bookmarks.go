...
var BookmarkWhere = struct {
	...
	ID:        whereHelperuint64{field: "`bookmarks`.`id`"},
	UserID:    whereHelperuint64{field: "`bookmarks`.`user_id`"},
	EntryID:   whereHelperuint64{field: "`bookmarks`.`entry_id`"},
	Comment:   whereHelperstring{field: "`bookmarks`.`comment`"},
...
var (
	bookmarkAllColumns            = []string{"id", "user_id", "entry_id", "comment", "created_at", "updated_at"}
	bookmarkColumnsWithoutDefault = []string{"user_id", "entry_id", "comment", "created_at", "updated_at"}
...
func (q bookmarkQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Bookmark, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: failed to execute a one query for bookmarks")
	}
...
func (q bookmarkQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to count bookmarks rows")
	}
...
func (q bookmarkQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "record: failed to check if bookmarks exists")
	}
...
func (o *Bookmark) BookmarkTagRelations(mods ...qm.QueryMod) bookmarkTagRelationQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`bookmark_tag_relations`.`bookmark_id`=?", o.ID),
	)

	query := BookmarkTagRelations(queryMods...)
	queries.SetFrom(query.Query, "`bookmark_tag_relations`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`bookmark_tag_relations`.*"})
	}
...
func (bookmarkL) LoadEntry(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBookmark interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`entries`), qm.WhereIn(`entries.id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (bookmarkL) LoadBookmarkTagRelations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBookmark interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`bookmark_tag_relations`), qm.WhereIn(`bookmark_tag_relations.bookmark_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load bookmark_tag_relations")
	}

	var resultSlice []*BookmarkTagRelation
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice bookmark_tag_relations")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on bookmark_tag_relations")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for bookmark_tag_relations")
	}
...
func (o *Bookmark) AddBookmarkTagRelations(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*BookmarkTagRelation) error {
	...
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				"UPDATE `bookmark_tag_relations` SET %s WHERE %s",
...
func FindBookmark(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Bookmark, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: unable to select from bookmarks")
	}
...
func (o *Bookmark) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("record: no bookmarks provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to insert into bookmarks")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to populate default values for bookmarks")
	}
...
func (o *Bookmark) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("record: unable to update bookmarks, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update bookmarks row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by update for bookmarks")
	}
...
func (q bookmarkQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update all for bookmarks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to retrieve rows affected for bookmarks")
	}
...
func (o *Bookmark) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("record: no bookmarks provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("record: unable to upsert bookmarks, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to upsert for bookmarks")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to retrieve unique values for bookmarks")
	}
...
func (o *Bookmark) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete from bookmarks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by delete for bookmarks")
	}
...
func (q bookmarkQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete all from bookmarks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by deleteall for bookmarks")
	}
...
func BookmarkExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "record: unable to check if bookmarks exists")
	}
