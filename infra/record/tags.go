...
var (
	tagAllColumns            = []string{"id", "content", "created_at", "updated_at"}
	tagColumnsWithoutDefault = []string{"content", "created_at", "updated_at"}
...
func (o *Tag) BookmarkTagRelations(mods ...qm.QueryMod) bookmarkTagRelationQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`bookmark_tag_relations`.`tag_id`=?", o.ID),
	)
...
func (tagL) LoadBookmarkTagRelations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`bookmark_tag_relations`), qm.WhereIn(`bookmark_tag_relations.tag_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Tag) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to populate default values for tags")
	}
...
func (o *Tag) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to upsert for tags")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to retrieve unique values for tags")
	}
