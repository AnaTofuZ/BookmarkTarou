...
var BookmarkTagRelationWhere = struct {
	...
	ID:         whereHelperuint64{field: "`bookmark_tag_relations`.`id`"},
	BookmarkID: whereHelperuint64{field: "`bookmark_tag_relations`.`bookmark_id`"},
	TagID:      whereHelperuint64{field: "`bookmark_tag_relations`.`tag_id`"},
	CreatedAt:  whereHelpertime_Time{field: "`bookmark_tag_relations`.`created_at`"},
	UpdatedAt:  whereHelpertime_Time{field: "`bookmark_tag_relations`.`updated_at`"},
}
...
var (
	bookmarkTagRelationAllColumns            = []string{"id", "bookmark_id", "tag_id", "created_at", "updated_at"}
	bookmarkTagRelationColumnsWithoutDefault = []string{"bookmark_id", "tag_id", "created_at", "updated_at"}
...
func (q bookmarkTagRelationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*BookmarkTagRelation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: failed to execute a one query for bookmark_tag_relations")
	}
...
func (q bookmarkTagRelationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to count bookmark_tag_relations rows")
	}
...
func (q bookmarkTagRelationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "record: failed to check if bookmark_tag_relations exists")
	}
...
func (bookmarkTagRelationL) LoadBookmark(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBookmarkTagRelation interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`bookmarks`), qm.WhereIn(`bookmarks.id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func BookmarkTagRelations(mods ...qm.QueryMod) bookmarkTagRelationQuery {
	mods = append(mods, qm.From("`bookmark_tag_relations`"))
...
func FindBookmarkTagRelation(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*BookmarkTagRelation, error) {
	...
	query := fmt.Sprintf(
		"select %s from `bookmark_tag_relations` where `id`=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: unable to select from bookmark_tag_relations")
	}
...
func (o *BookmarkTagRelation) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("record: no bookmark_tag_relations provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO `bookmark_tag_relations` (`%s`) %%sVALUES (%s)%%s", strings.Join(wl, "`,`"), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO `bookmark_tag_relations` () VALUES ()%s%s"
		}

		var queryOutput, queryReturning string

		if len(cache.retMapping) != 0 {
			cache.retQuery = fmt.Sprintf("SELECT `%s` FROM `bookmark_tag_relations` WHERE %s", strings.Join(returnColumns, "`,`"), strmangle.WhereClause("`", "`", 0, bookmarkTagRelationPrimaryKeyColumns))
		}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to insert into bookmark_tag_relations")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to populate default values for bookmark_tag_relations")
	}
...
func (o *BookmarkTagRelation) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("record: unable to update bookmark_tag_relations, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE `bookmark_tag_relations` SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update bookmark_tag_relations row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by update for bookmark_tag_relations")
	}
...
func (q bookmarkTagRelationQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update all for bookmark_tag_relations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to retrieve rows affected for bookmark_tag_relations")
	}
...
func (o BookmarkTagRelationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE `bookmark_tag_relations` SET %s WHERE %s",
...
func (o *BookmarkTagRelation) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("record: no bookmark_tag_relations provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("record: unable to upsert bookmark_tag_relations, could not build update column list")
		}

		ret = strmangle.SetComplement(ret, nzUniques)
		cache.query = buildUpsertQueryMySQL(dialect, "bookmark_tag_relations", update, insert)
		cache.retQuery = fmt.Sprintf(
			"SELECT %s FROM `bookmark_tag_relations` WHERE %s",
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to upsert for bookmark_tag_relations")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to retrieve unique values for bookmark_tag_relations")
	}
...
func (o *BookmarkTagRelation) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM `bookmark_tag_relations` WHERE `id`=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete from bookmark_tag_relations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by delete for bookmark_tag_relations")
	}
...
func (q bookmarkTagRelationQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete all from bookmark_tag_relations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by deleteall for bookmark_tag_relations")
	}
...
func (o BookmarkTagRelationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM `bookmark_tag_relations` WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, bookmarkTagRelationPrimaryKeyColumns, len(o))
...
func (o *BookmarkTagRelationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT `bookmark_tag_relations`.* FROM `bookmark_tag_relations` WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, bookmarkTagRelationPrimaryKeyColumns, len(*o))
...
func BookmarkTagRelationExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `bookmark_tag_relations` where `id`=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "record: unable to check if bookmark_tag_relations exists")
	}
