...
var TagWhere = struct {
	...
	Content: whereHelperstring{field: "`tag`.`content`"},
}
...
var (
	tagAllColumns            = []string{"id", "content"}
	tagColumnsWithoutDefault = []string{"content"}
...
func (q tagQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Tag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: failed to execute a one query for tag")
	}
...
func (q tagQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to count tag rows")
	}
...
func (q tagQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "record: failed to check if tag exists")
	}
...
func (o *Tag) BookmarkTagRelations(mods ...qm.QueryMod) bookmarkTagRelationQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`bookmark_tag_relation`.`tag_id`=?", o.ID),
	)
...
func (tagL) LoadBookmarkTagRelations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	var slice []*Tag
	var object *Tag
	...
	query := NewQuery(qm.From(`bookmark_tag_relation`), qm.WhereIn(`bookmark_tag_relation.tag_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Tag) AddBookmarkTagRelations(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*BookmarkTagRelation) error {
	var err error
...
func FindTag(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Tag, error) {
	tagObj := &Tag{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: unable to select from tag")
	}
...
func (o *Tag) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("record: no tag provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to insert into tag")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to populate default values for tag")
	}
...
func (o *Tag) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("record: unable to update tag, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update tag row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by update for tag")
	}
...
func (q tagQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update all for tag")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to retrieve rows affected for tag")
	}
...
func (o *Tag) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("record: no tag provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("record: unable to upsert tag, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to upsert for tag")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to retrieve unique values for tag")
	}
...
func (o *Tag) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete from tag")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by delete for tag")
	}
...
func (q tagQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete all from tag")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by deleteall for tag")
	}
...
func TagExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "record: unable to check if tag exists")
	}
