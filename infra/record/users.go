...
var UserWhere = struct {
	...
	Name:      whereHelper__byte{field: "`users`.`name`"},
...
func (userL) LoadBookmarks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`bookmarks`), qm.WhereIn(`bookmarks.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to populate default values for users")
	}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to retrieve unique values for users")
	}
